...
class ThemeSettings {
  ...
  const ThemeSettings({
    ...
    this.opacity = 0.35,
    this.scale = 1.0,
    this.cardColorValue = 0x00000000,
    this.cardOpacity = 0.90,
    this.cardBorderColorValue = 0xFF6750A4,
    this.navColorValue = 0x00000000,
...
class ThemeService {
  ...
  static Future<ThemeSettings> load() async {
    ...
    return ThemeSettings(
      ...
      cardColorValue: prefs.getInt(_cardColorKey) ?? 0x00000000,
      ...
      navColorValue: prefs.getInt(_navColorKey) ?? 0x00000000,
