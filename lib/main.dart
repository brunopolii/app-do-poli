    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: const BorderSide(width: 2, color: seed)),
        ),
      ),
      darkTheme: ThemeData(
        useMaterial3: true,
      ...
      home: Scaffold(
        ...
        body: IndexedStack(
          index: selectedIndex,
          children: const [AgendaScreen(), GymScreen(), HomeScreen(), FoodScreen(), FinanceScreen()],
        ),
